  ...
  <body>
    ...
    <main>
      ...
      <article>
        ...
        <h3>Редакторы</h3>
        <p>
          <a href="http://plnkr.co/">Plunker</a> - мощный и простой онлайн
          редактор HTML + CSS + JS с возможностью сохранения своих работ и обмена
          ими.
        </p>
        <p>
          <a href="https://atom.io/">Atom</a> -  прекрасный, бесплатный, мощный кросплатформенный текстовый редактор от GitHub
        </p>
        <p>
          <a href="http://www.sublimetext.com/3">Sublime Text</a> -  великолепный текстовый редактор, позволяющий ускорить разработку проекта в несколько раз. Единственный минус - он платный. Чтобы быстро и просто устанавливать дополнения, скачайте <a href="https://packagecontrol.io/installation">Package control</a>
        </p>
